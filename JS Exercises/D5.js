...
const carsLastObj = Object.assign({}, cars[1]);
console.log(carsLastObj);

carsLastObj.brand = "Ferrari";
carsLastObj.color = "Rosso Ferrari";
carsLastObj.model = "Ferrari Enzo";
carsLastObj.trims = ["edizione limitata", "corsa"];
console.log(carsLastObj);

cars.push(carsLastObj);
console.log(cars);
